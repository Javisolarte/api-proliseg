-- ============================================================
-- ARREGLAR COLUMNAS FALTANTES Y CACHÉ DE SUPABASE
-- ============================================================

-- Agregar TODAS las columnas nuevas que puedan faltar porque la tabla
-- ya existía antes de correr la migración.
...
-- Recargar el esquema en caché de Supabase (PostgREST)
